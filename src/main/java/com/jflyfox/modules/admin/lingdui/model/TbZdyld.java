...
public class TbZdyld extends BaseModel<TbZdyld> {
    ...
    private String DY_SHENFZ = "dy_shenfz";  // 身份证号
    private String DY_ZIGEZH = "dy_zigezh";  // 资格证号
    private String DY_SHENQING = "dy_shenqing";  // 申请时间
    private String DY_SHENPI = "dy_shenpi";  // 审批时间
    private String DY_BEIAN = "dy_beian";  // 备案时间
    ...
    public TbZdyld setDyShenfz(String value) {
        set(DY_SHENFZ, value);
        return this;
    }

	public String getDyShenfz() {
		return get(DY_SHENFZ);
	}
    public TbZdyld setDyZigezh(String value) {
        set(DY_ZIGEZH, value);
        return this;
    }

	public String getDyZigezh() {
		return get(DY_ZIGEZH);
	}
    public TbZdyld setDyShenqing(String value) {
        set(DY_SHENQING, value);
        return this;
    }

	public String getDyShenqing() {
		return get(DY_SHENQING);
	}
    public TbZdyld setDyShenpi(String value) {
        set(DY_SHENPI, value);
        return this;
    }

	public String getDyShenpi() {
		return get(DY_SHENPI);
	}
    public TbZdyld setDyBeian(String value) {
        set(DY_BEIAN, value);
        return this;
    }

	public String getDyBeian() {
		return get(DY_BEIAN);
	}
	...
	public String toString() {
		...
		log += "[dyShenfz:" + getDyShenfz() + "]";
		log += "[dyZigezh:" + getDyZigezh() + "]";
		log += "[dyShenqing:" + getDyShenqing() + "]";
		log += "[dyShenpi:" + getDyShenpi() + "]";
		log += "[dyBeian:" + getDyBeian() + "]";
